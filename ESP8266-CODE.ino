...
const int ledPin = D2;      // set digital pin D8 as LED pin (use super bright LED)
const int wifiLedPin = D4;  // set digital pin D0 as indication, the LED turn on if NodeMCU connected to WiFi as STA mode
